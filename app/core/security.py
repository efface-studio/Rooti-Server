...
def create_access_token(user_id: int, username: str, roles: list[str]) -> str:
    return create_token(user_id=user_id, username=username, roles=roles, token_type="ACCESS")


def create_refresh_token(user_id: int, username: str, roles: list[str]) -> str:
    return create_token(user_id=user_id, username=username, roles=roles, token_type="REFRESH")
